...
const studioList = [
  {
    img:
      "https://images.unsplash.com/photo-1609220136736-443140cffec6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80",
    name: "아우러룸",
    location: "서울특별시 강남구 테헤란로 359-12 1층",
    desc:
      "아우러룸은 어쩌고 상세 설명을 써서 여기에 이만큼 보여주고 2줄까지 가능하도록 한다...",
    tags: ["해시태그", "키워드", "무드", "포스트모던"],
    user: {
      name: "마스터픽픽스",
      category: "model",
    },
  ...
  {
    img:
      "https://images.unsplash.com/photo-1581952976147-5a2d15560349?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=751&q=80",
    name: "505스튜디오",
    location: "서울특별시 강남구 테헤란로 359-12 1층",
    desc:
      "아우러룸은 어쩌고 상세 설명을 써서 여기에 이만큼 보여주고 2줄까지 가능하도록 한다...",
